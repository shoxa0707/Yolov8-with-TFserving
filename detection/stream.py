...
def grpc(image, url, input_name='x', model_name='yolo', output_name='output_0'):
    import grpc
    ...
    pred.resize(25200, 85)
    
    return pred

st.markdown("<h1 style='text-align: center; color: green;'>YOLOV5</h1>", unsafe_allow_html=True)
            ...
            while(cap.isOpened()):
                ...
                if ret == True:
                    ...
                    if api == 'REST API':
                        ...
                        pred = grpc(image=im, url=GRPC_URL, input_name='x', model_name='yolo', output_name='output_0')
